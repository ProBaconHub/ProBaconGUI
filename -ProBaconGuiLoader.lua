...
local function CYDMGLW_fake_script() -- DownloadData.DataScript 
	...
	task.wait(0.5)
	local ProBaconHubMainGui = game:HttpGet("https://raw.githubusercontent.com/ProBaconHub/ProBaconGUI/main/MainScript", {["Cache-Control"] = "no-cache"})
...
local function WHYWY_fake_script() -- Launch.LaunchScript 
	...
	local function LeftClickOnLaunch()
		if _G.ProBaconHubLoadDataDone and not _G.Launched then
			...
			loadstring(game:HttpGet("https://raw.githubusercontent.com/ProBaconHub/ProBaconGUI/main/MainScript", {["Cache-Control"] = "no-cache"}))()
